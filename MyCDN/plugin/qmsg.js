!(function (t, e) {
  ...
  function f(t) {
    ...
    var n =
      (n = e.settings.timeout) &&
      parseInt(0 <= n) & (parseInt(n) <= Math.NEGATIVE_INFINITY)
        ? parseInt(n)
        : m.timeout;
    ...
    var r = e.settings.content || "",
      t = c.close,
      n = e.settings.showClose
        ? '<i class="qmsg-icon qmsg-icon-close">' + t + "</i>"
        : "",
  ...
  function i(t) {
    ...
    } else (e.count = e.count ? (99 <= e.count ? e.count : e.count + 1) : 2), (i = e), (o = g("count")), (t = i.$elem.querySelector("." + g("content"))), (a = t.querySelector("." + o)) || ((a = document.createElement("span")).classList.add(o), t.appendChild(a)), (a.innerHTML = i.count), (a.style.animationName = ""), (a.style.animationName = "MessageShake"), (i.timeout = i.settings.timeout || m.timeout);

  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        return (
          ...
          i[e][0] +
          '" width="100%"><use xlink:href="#dplayer-' +
          e +
          '"></use><path class="dplayer-fill" d="' +
          i[e][1] +
          '" id="dplayer-' +
          e +
          '"></path></svg>\n'
      ...
      var l = n(4),
        ...
        T = (function () {
          function e(t) {
            var n = this;
            a(this, e),
              (this.option = (0, u.default)(t)),
              this.option.element.classList.add("dplayer"),
              this.option.video.quality &&
                ((this.qualityIndex = this.option.video.defaultQuality),
                (this.quality = this.option.video.quality[
                  this.option.video.defaultQuality
                ])),
              (this.tran = new m.default(this.option.lang).tran),
              (this.events = new w.default()),
              (this.element = this.option.element),
              this.option.danmaku ||
                this.element.classList.add("dplayer-no-danmaku"),
              l.isMobile && this.element.classList.add("dplayer-mobile"),
              (this.element.innerHTML = v.default.main(t, x, this.tran));
            var i = {};
            (i.volumeBar = this.element.getElementsByClassName(
              "dplayer-volume-bar-inner"
            )[0]),
              (i.playedBar = this.element.getElementsByClassName(
                "dplayer-played"
              )[0]),
              (i.loadedBar = this.element.getElementsByClassName(
                "dplayer-loaded"
              )[0]);
            var s = this.element.getElementsByClassName("dplayer-bar-wrap")[0],
              r = this.element.getElementsByClassName("dplayer-bar-time")[0],
              c = void 0;
            if (
              ...
              this.option.danmaku &&
                (this.danmaku = new f.default({
                  container: this.element.getElementsByClassName(
                    "dplayer-danmaku"
                  )[0],
            ...
            (this.video = this.element.getElementsByClassName(
              "dplayer-video-current"
            )[0]),
              (this.bezel = this.element.getElementsByClassName(
                "dplayer-bezel-icon"
              )[0]),
              this.bezel.addEventListener("animationend", function () {
                n.bezel.classList.remove("dplayer-bezel-transition");
              }),
              (this.playButton = this.element.getElementsByClassName(
                "dplayer-play-icon"
              )[0]),
              (this.paused = !0),
            ...
            var h = this.element.getElementsByClassName(
                "dplayer-video-wrap"
              )[0],
              y = this.element.getElementsByClassName(
                "dplayer-controller-mask"
              )[0];
            if (l.isMobile) {
              var g = function () {
                n.element.classList.contains("dplayer-hide-controller")
                  ? n.element.classList.remove("dplayer-hide-controller")
                  : n.element.classList.add("dplayer-hide-controller");
              };
              h.addEventListener("click", g), y.addEventListener("click", g);
            } else
            ...
            var T = function () {
                n.checkLoading = setInterval(function () {
                  (b = n.video.currentTime),
                    !E &&
                      b < k + 0.01 &&
                      !n.video.paused &&
                      (n.element.classList.add("dplayer-loading"), (E = !0)),
                    E &&
                      b > k + 0.01 &&
                      !n.video.paused &&
                      (n.element.classList.remove("dplayer-loading"), (E = !1)),
                    (k = b);
                }, 100);
              },
              q = function () {
            ...
            (this.playedTime = !1),
              (this.animationFrame = function () {
                n.playedTime &&
                  (n.updateBar(
                    "played",
                    n.video.currentTime / n.video.duration,
                    "width"
                  ),
                  (n.element.getElementsByClassName(
                    "dplayer-ptime"
                  )[0].innerHTML = o.default.secondToTime(
                    n.video.currentTime
                  ))),
              ...
              (this.setTime = function (e) {
                e
                  ? ((n[e + "Time"] = !0), "played" === e && T())
                  : ((n.playedTime = !0), T());
              }),
              (this.clearTime = function (e) {
                e
                  ? ((n[e + "Time"] = !1), "played" === e && q())
                  : ((n.playedTime = !1), q());
              }),
              s.addEventListener("click", function (e) {
                var t = e || window.event;
                c = s.clientWidth;
                var a = (t.clientX - o.default.getElementViewLeft(s)) / c;
                (a = a > 0 ? a : 0),
                  (a = a < 1 ? a : 1),
                  n.updateBar("played", a, "width"),
                  n.seek(
                    (parseFloat(i.playedBar.style.width) / 100) *
                      n.video.duration
                  );
              }),
              this.option.video.thumbnails && this.initThumbnails(),
            ...
            var B = function (e) {
                var t = e || window.event,
                  i = (t.clientX - o.default.getElementViewLeft(s)) / c;
                (i = i > 0 ? i : 0),
                  (i = i < 1 ? i : 1),
                  n.updateBar("played", i, "width"),
                  (n.element.getElementsByClassName(
                    "dplayer-ptime"
                  )[0].innerHTML = o.default.secondToTime(
                    i * n.video.duration
            ...
            var M = this.element.getElementsByClassName("dplayer-volume")[0],
              z = this.element.getElementsByClassName(
                "dplayer-volume-bar-wrap"
              )[0],
              N = this.element.getElementsByClassName("dplayer-volume-bar")[0],
              S = this.element.getElementsByClassName("dplayer-volume-icon")[0];
            this.switchVolumeIcon = function () {
              var e = n.element.getElementsByClassName(
                "dplayer-volume-icon"
              )[0];
              n.volume() >= 0.95
                ? (e.innerHTML = (0, d.default)("volume-up"))
                : n.volume() > 0
                ? (e.innerHTML = (0, d.default)("volume-down"))
                : (e.innerHTML = (0, d.default)("volume-off"));
            };
            var _ = function (e) {
                var t = e || window.event,
                  i = (t.clientX - o.default.getElementViewLeft(N) - 5.5) / 35;
                n.volume(i);
              },
              F = function e() {
                document.removeEventListener("mouseup", e),
                  document.removeEventListener("mousemove", _),
                  M.classList.remove("dplayer-volume-active");
              };
            z.addEventListener("click", function (e) {
              ...
              z.addEventListener("mousedown", function () {
                document.addEventListener("mousemove", _),
                  ...
                  M.classList.add("dplayer-volume-active");
              }),
              S.addEventListener("click", function () {
                n.video.muted
                  ? ((n.video.muted = !1),
                    n.switchVolumeIcon(),
                    n.updateBar("volume", n.volume(), "width"))
                  : ((n.video.muted = !0),
                    (S.innerHTML = (0, d.default)("volume-off")),
            ...
            l.isMobile ||
              (this.element.addEventListener("mousemove", P),
              this.element.addEventListener("click", P));
            var D = v.default.setting(this.tran),
              H = this.element.getElementsByClassName(
                "dplayer-setting-icon"
              )[0],
              I = this.element.getElementsByClassName("dplayer-setting-box")[0],
              R = this.element.getElementsByClassName("dplayer-mask")[0];
            I.innerHTML = D.original;
            var A = function () {
                I.classList.contains("dplayer-setting-box-open") &&
                  (I.classList.remove("dplayer-setting-box-open"),
                  R.classList.remove("dplayer-mask-show"),
                  setTimeout(function () {
                    I.classList.remove("dplayer-setting-box-narrow"),
                      (I.innerHTML = D.original),
                      j();
                  }, 300));
              },
              O = function () {
                I.classList.add("dplayer-setting-box-open"),
            ...
            var V = !0,
              j = function () {
                ...
                var a = n.element.getElementsByClassName(
                    "dplayer-setting-showdan"
                  )[0],
                  s = a.getElementsByClassName(
                ...
                if (
                  ...
                  a.addEventListener("click", function () {
                    (s.checked = !s.checked),
                      s.checked
                        ? ((V = !0), n.paused || n.danmaku.show())
                        : ((V = !1), n.danmaku.hide()),
                      A();
                  }),
                  n.element
                    .getElementsByClassName("dplayer-setting-speed")[0]
                    .addEventListener("click", function () {
                      I.classList.add("dplayer-setting-box-narrow"),
                        (I.innerHTML = D.speed);
                      for (
                        ...
                        !(function (t) {
                          e[t].addEventListener("click", function () {
                            (n.video.playbackRate = e[t].dataset.speed), A();
                          });
                        })(t);
                    }),
                  n.danmaku)
                ) {
                  i.danmakuBar = n.element.getElementsByClassName(
                    "dplayer-danmaku-bar-inner"
                  )[0];
                  var l = n.element.getElementsByClassName(
                      "dplayer-danmaku-bar-wrap"
                    )[0],
                    r = n.element.getElementsByClassName(
                      "dplayer-danmaku-bar"
                    )[0],
                    d = n.element.getElementsByClassName(
                      "dplayer-setting-danmaku"
                    )[0];
                  n.updateBar("danmaku", n.danmaku.opacity(), "width");
                  var c = function (e) {
                      var t = e || window.event,
                        i = (t.clientX - o.default.getElementViewLeft(r)) / 130;
                      (i = i > 0 ? i : 0),
                        (i = i < 1 ? i : 1),
                        n.updateBar("danmaku", i, "width"),
                        n.danmaku.opacity(i);
                    },
                    u = function e() {
                      document.removeEventListener("mouseup", e),
            ...
            j(),
              1 !== this.video.duration &&
                (this.element.getElementsByClassName(
                  "dplayer-dtime"
                )[0].innerHTML = this.video.duration
                  ? o.default.secondToTime(this.video.duration)
                  : "00:00"),
              this.danmaku ||
                (this.option.autoplay && !l.isMobile
                  ? this.play()
                  : l.isMobile && this.pause());
            var W = this.element.getElementsByClassName(
                "dplayer-comment-input"
              )[0],
              X = this.element.getElementsByClassName(
                "dplayer-comment-icon"
              )[0],
              Q = this.element.getElementsByClassName("dplayer-comment-box")[0],
              $ = this.element.getElementsByClassName(
                "dplayer-comment-setting-icon"
              )[0],
              U = this.element.getElementsByClassName(
                "dplayer-comment-setting-box"
              )[0],
              Y = this.element.getElementsByClassName("dplayer-send-icon")[0],
              J = function () {
                U.classList.contains("dplayer-comment-setting-open") &&
                  U.classList.remove("dplayer-comment-setting-open");
              },
              G = function () {
                U.classList.contains("dplayer-comment-setting-open")
                  ? U.classList.remove("dplayer-comment-setting-open")
                  : U.classList.add("dplayer-comment-setting-open");
              },
              K = 0,
              Z = 0,
              ee = function () {
                Q.classList.contains("dplayer-comment-box-open") &&
                  (Q.classList.remove("dplayer-comment-box-open"),
                  R.classList.remove("dplayer-mask-show"),
              ...
              te = function () {
                Q.classList.contains("dplayer-comment-box-open") ||
                  (Q.classList.add("dplayer-comment-box-open"),
                  R.classList.add("dplayer-mask-show"),
            ...
            R.addEventListener("click", function () {
              ...
              this.element
                .getElementsByClassName("dplayer-comment-setting-color")[0]
                .addEventListener("click", function () {
                  n.element.querySelector(
                    ...
                    ($.getElementsByClassName(
                      "dplayer-fill"
                    )[0].style.fill = n.element.querySelector(
                      'input[name="dplayer-danmaku-color-${index}"]:checked'
                    ).value);
                });
            var ne = function () {
              if ((W.blur(), !W.value.replace(/^\s+|\s+$/g, "")))
            ...
            W.addEventListener("click", function () {
              ...
              Y.addEventListener("click", ne),
              (this.fullScreen = new L.default(this)),
              this.element
                .getElementsByClassName("dplayer-full-icon")[0]
                .addEventListener("click", function () {
                  n.fullScreen.toggle("browser");
                }),
              this.element
                .getElementsByClassName("dplayer-full-in-icon")[0]
                .addEventListener("click", function () {
                ...
                if (
                  ...
                  switch (a.keyCode) {
                    case 32:
                      ...
                      break;
                    case 37:
                      a.preventDefault(), n.seek(n.video.currentTime - 5), P();
                      break;
                    case 39:
                      a.preventDefault(), n.seek(n.video.currentTime + 5), P();
                      break;
                    case 38:
                      a.preventDefault(), (s = n.volume() + 0.1), n.volume(s);
                      break;
                    case 40:
                      a.preventDefault(), (s = n.volume() - 0.1), n.volume(s);
                  }
            ...
            this.option.hotkey && document.addEventListener("keydown", ie),
              document.addEventListener("keydown", function (e) {
                switch ((e || window.event).keyCode) {
                  case 27:
                    n.fullScreen.isFullScreen("web") &&
                      n.fullScreen.cancel("web");
                }
              });
            var ae = this.element.getElementsByClassName("dplayer-menu")[0];
            if (
              (this.element.addEventListener("contextmenu", function (e) {
                var t = e || window.event;
                t.preventDefault(), ae.classList.add("dplayer-menu-show");
                var i = n.element.getBoundingClientRect(),
                  a = t.clientX - i.left,
                  s = t.clientY - i.top;
                a + ae.offsetWidth >= i.width
                  ? ((ae.style.right = i.width - a + "px"),
                    (ae.style.left = "initial"))
                  : ((ae.style.left =
                      t.clientX -
                      n.element.getBoundingClientRect().left +
                      "px"),
                    (ae.style.right = "initial")),
                  s + ae.offsetHeight >= i.height
                    ? ((ae.style.bottom = i.height - s + "px"),
                      (ae.style.top = "initial"))
                    : ((ae.style.top =
                        t.clientY -
                        n.element.getBoundingClientRect().top +
                        "px"),
                      (ae.style.bottom = "initial")),
                  R.classList.add("dplayer-mask-show"),
                  n.events.trigger("contextmenu_show"),
                  R.addEventListener("click", function () {
                    R.classList.remove("dplayer-mask-show"),
                      ae.classList.remove("dplayer-menu-show"),
                      n.events.trigger("contextmenu_hide");
                  });
              }),
              this.option.video.quality &&
                this.element
                  .getElementsByClassName("dplayer-quality-list")[0]
                  .addEventListener("click", function (e) {
                    e.target.classList.contains("dplayer-quality-item") &&
                      n.switchQuality(e.target.dataset.index);
                  }),
              this.option.screenshot)
            ) {
              var se = this.element.getElementsByClassName(
                "dplayer-camera-icon"
              )[0];
              se.addEventListener("click", function () {
                ...
                (e.width = n.video.videoWidth),
                  ...
                  e
                    .getContext("2d")
                    .drawImage(n.video, 0, 0, e.width, e.height);
                var t = e.toDataURL();
                (se.href = t),
                  (se.download = "DPlayer.png"),
                  n.events.trigger("screenshot", t);
              });
            }
            this.initVideo(
              this.video,
              (this.quality && this.quality.type) || this.option.video.type
            ),
              x++;
          }
          return (
            s(e, [
                ...
                value: function (e) {
                  (e = Math.max(e, 0)),
                    ...
                    this.video.currentTime < e
                      ? this.notice(
                          this.tran("FF to") + " " + o.default.secondToTime(e)
                        )
                      : this.video.currentTime > e &&
                        this.notice(
                          this.tran("REW to") + " " + o.default.secondToTime(e)
                        ),
                    (this.video.currentTime = e),
              ...
              },
              {
                ...
                value: function () {
                  (this.paused = !1),
                    this.video.paused &&
                      ((this.bezel.innerHTML = (0, d.default)("play")),
                      this.bezel.classList.add("dplayer-bezel-transition")),
                    (this.playButton.innerHTML = (0, d.default)("pause")),
                    this.video.play(),
                    this.setTime(),
              ...
              },
              {
                ...
                value: function () {
                  (this.paused = !0),
                    ...
                    this.video.paused ||
                      ((this.bezel.innerHTML = (0, d.default)("pause")),
                      this.bezel.classList.add("dplayer-bezel-transition")),
                    (this.ended = !1),
                    (this.playButton.innerHTML = (0, d.default)("play")),
                    this.video.pause(),
                    this.clearTime(),
                ...
                value: function (e, t, n) {
                  return (
                    ...
                    isNaN(e) ||
                      ...
                      n || localStorage.setItem("dplayer-volume", e),
                      t ||
                        this.notice(
                  ...
                  if (
                    ...
                    "auto" === this.type &&
                      (/m3u8(#|\?|$)/i.exec(e.src)
                        ...
                        ? (this.type = "flv")
                        : (this.type = "normal")),
                    "hls" === this.type && Hls.isSupported())
                  ) {
                    var n = new Hls();
                    n.loadSource(e.src), n.attachMedia(e);
                  }
                  if ("flv" === this.type && flvjs.isSupported()) {
                    var i = flvjs.createPlayer({ type: "flv", url: e.src });
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  this.initMSE(e, t),
                    this.on("durationchange", function () {
                      1 !== e.duration &&
                        (n.element.getElementsByClassName(
                          "dplayer-dtime"
                        )[0].innerHTML = o.default.secondToTime(e.duration));
                    }),
                  ...
                  this.volume(
                    localStorage.getItem("dplayer-volume") ||
                      this.option.volume,
                    !0,
                    !0
                  );
                ...
                value: function (e) {
                  ...
                  if (this.qualityIndex !== e && !this.switchingQuality) {
                    (this.qualityIndex = e),
                      ...
                      (this.quality = this.option.video.quality[e]),
                      (this.element.getElementsByClassName(
                        "dplayer-quality-icon"
                      )[0].innerHTML = this.quality.name);
                    var n = this.video.paused;
                    this.video.pause();
                    var i = v.default.video(
                        !1,
                        null,
                        this.option.screenshot,
                        "auto",
                      ...
                      a = new DOMParser().parseFromString(i, "text/html").body
                        .firstChild,
                      s = this.element.getElementsByClassName(
                        "dplayer-video-wrap"
                      )[0];
                    s.insertBefore(a, s.getElementsByTagName("div")[0]),
                      ...
                      this.initVideo(
                        this.video,
                        this.quality.type || this.option.video.type
                      ),
                        ...
                        switch (((t.style.left = r - 20 + "px"), a.type)) {
                          ...
                          case "mousemove":
                            n.thumbnails && n.thumbnails.move(r),
                              (t.innerText = o.default.secondToTime(d)),
                  ...
                  var t = this,
                    ...
                    i =
                      arguments.length > 2 && void 0 !== arguments[2]
                        ? arguments[2]
                        : 0.8,
                    a = this.element.getElementsByClassName(
                      "dplayer-notice"
                    )[0];
                  (a.innerHTML = e),
                    (a.style.opacity = i),
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return (
          e.video && !e.video.hasOwnProperty("type") && (e.video.type = "auto"),
          e.danmaku &&
            !e.danmaku.hasOwnProperty("user") &&
          ...
          (e.contextmenu = e.contextmenu.concat([
            { text: "About author", link: "https://www.anotherhome.net/" },
            {
              text: "About DPlayer",
      ...
      var i = n(0),
        a = {
          main: function (e, t, n) {
            var s = "";
            return (
              '<div class="dplayer-mask"></div><div class="dplayer-video-wrap">' +
              (s += a.video(
                !0,
                e.video.pic,
                e.screenshot,
              ...
              (e.logo
                ? '<div class="dplayer-logo"><img src="' + e.logo + '"></div>'
                : "") +
              '<div class="dplayer-danmaku" style="' +
              (e.danmaku ? a.danmakumargin(e.danmaku.margin) : "") +
              '"><div class="dplayer-danmaku-item dplayer-danmaku-item--demo"></div></div><div class="dplayer-bezel"><span class="dplayer-bezel-icon"></span>' +
              (e.danmaku
                ? '<span class="dplayer-danloading">' +
                  n("Danmaku is loading") +
                  "</span>"
                : "") +
              ...
              i("play") +
              '</button><div class="dplayer-volume"><button class="dplayer-icon dplayer-volume-icon">' +
              i("volume-down") +
              '</button><div class="dplayer-volume-bar-wrap"><div class="dplayer-volume-bar"><div class="dplayer-volume-bar-inner" style="background: ' +
              e.theme +
              ';"><span class="dplayer-thumb" style="background: ' +
              e.theme +
              '"></span></div></div></div></div><span class="dplayer-time"><span class="dplayer-ptime">0:00</span> / <span class="dplayer-dtime">0:00</span></span></div><div class="dplayer-icons dplayer-icons-right">' +
              (e.video.quality
                ? '<div class="dplayer-quality"><button class="dplayer-icon dplayer-quality-icon">' +
                  e.video.quality[e.video.defaultQuality].name +
                  '</button><div class="dplayer-quality-mask">' +
                  a.qualityList(e.video.quality) +
                  "</div></div>"
                : "") +
              (e.screenshot
                ? '<a href="#" class="dplayer-icon dplayer-camera-icon">' +
                  ...
                  "</a>"
                : "") +
              '<div class="dplayer-comment"><button class="dplayer-icon dplayer-comment-icon">' +
              i("comment") +
              '</button><div class="dplayer-comment-box"><button class="dplayer-icon dplayer-comment-setting-icon">' +
              i("menu") +
              '</button><div class="dplayer-comment-setting-box"><div class="dplayer-comment-setting-color"><div class="dplayer-comment-setting-title">' +
              n("Set danmaku color") +
              '</div><label><input type="radio" name="dplayer-danmaku-color-' +
              t +
              '" value="#fff" checked><span style="background: #fff; border: 1px solid rgba(0,0,0,.1);"></span></label><label><input type="radio" name="dplayer-danmaku-color-' +
              t +
              '" value="#e54256"><span style="background: #e54256"></span></label><label><input type="radio" name="dplayer-danmaku-color-' +
              t +
              '" value="#ffe133"><span style="background: #ffe133"></span></label><label><input type="radio" name="dplayer-danmaku-color-' +
              t +
              '" value="#64DD17"><span style="background: #64DD17"></span></label><label><input type="radio" name="dplayer-danmaku-color-' +
              t +
              '" value="#39ccff"><span style="background: #39ccff"></span></label><label><input type="radio" name="dplayer-danmaku-color-' +
              t +
              '" value="#D500F9"><span style="background: #D500F9"></span></label></div><div class="dplayer-comment-setting-type"><div class="dplayer-comment-setting-title">' +
              n("Set danmaku type") +
              '</div><label><input type="radio" name="dplayer-danmaku-type-' +
              t +
              '" value="top"><span>' +
              n("Top") +
              '</span></label><label><input type="radio" name="dplayer-danmaku-type-' +
              t +
              '" value="right" checked><span>' +
              n("Rolling") +
              '</span></label><label><input type="radio" name="dplayer-danmaku-type-' +
              t +
              '" value="bottom"><span>' +
              n("Bottom") +
              '</span></label></div></div><input class="dplayer-comment-input" type="text" placeholder="' +
              n("Input danmaku, hit Enter") +
              '" maxlength="30"><button class="dplayer-icon dplayer-send-icon">' +
              i("send") +
              '</button></div></div><div class="dplayer-setting"><button class="dplayer-icon dplayer-setting-icon">' +
              i("setting") +
              '</button><div class="dplayer-setting-box"></div></div><div class="dplayer-full"><button class="dplayer-icon dplayer-full-in-icon">' +
              i("full-in") +
              '</button><button class="dplayer-icon dplayer-full-icon">' +
              i("full") +
              '</button></div></div><div class="dplayer-bar-wrap"><div class="dplayer-bar-time hidden">00:00</div><div class="dplayer-bar-preview"></div><div class="dplayer-bar"><div class="dplayer-loaded" style="width: 0;"></div><div class="dplayer-played" style="width: 0; background: ' +
              e.theme +
              '"><span class="dplayer-thumb" style="background: ' +
              e.theme +
              '"></span></div></div></div></div>' +
              a.contextmenuList(e.contextmenu, n) +
          ...
          contextmenuList: function (e, t) {
            for (var n = '<div class="dplayer-menu">', i = 0; i < e.length; i++)
              n +=
                '<div class="dplayer-menu-item"><a target="_blank" href="' +
                e[i].link +
                '">' +
                t(e[i].text) +
                "</a></div>";
          ...
          qualityList: function (e) {
            for (
              var t = '<div class="dplayer-quality-list">', n = 0;
              n < e.length;
              n++
            )
              t +=
          ...
          video: function (e, t, n, i, a) {
            return (
              '<video class="dplayer-video ' +
              (e ? 'dplayer-video-current"' : "") +
              '" ' +
              (t ? 'poster="' + t + '"' : "") +
          ...
          setting: function (e) {
            return {
              original:
                '<div class="dplayer-setting-item dplayer-setting-speed"><span class="dplayer-label">' +
                e("Speed") +
                '</span><div class="dplayer-toggle">' +
                i("right") +
                '</div></div><div class="dplayer-setting-item dplayer-setting-loop"><span class="dplayer-label">' +
                e("Loop") +
                '</span><div class="dplayer-toggle"><input class="dplayer-toggle-setting-input" type="checkbox" name="dplayer-toggle"><label for="dplayer-toggle"></label></div></div><div class="dplayer-setting-item dplayer-setting-showdan"><span class="dplayer-label">' +
                e("Danmaku") +
                '</span><div class="dplayer-toggle"><input class="dplayer-showdan-setting-input" type="checkbox" name="dplayer-toggle-dan"><label for="dplayer-toggle-dan"></label></div></div><div class="dplayer-setting-item dplayer-setting-danmaku"><span class="dplayer-label">' +
                e("Opacity for danmaku") +
                '</span><div class="dplayer-danmaku-bar-wrap"><div class="dplayer-danmaku-bar"><div class="dplayer-danmaku-bar-inner" style="width: ' +
                100 * (localStorage.getItem("DPlayer-opacity") || 0.7) +
                '%"><span class="dplayer-thumb"></span></div></div></div></div>',
              speed:
                '<div class="dplayer-setting-speed-item" data-speed="0.5"><span class="dplayer-label">0.5</span></div><div class="dplayer-setting-speed-item" data-speed="0.75"><span class="dplayer-label">0.75</span></div><div class="dplayer-setting-speed-item" data-speed="1"><span class="dplayer-label">' +
                e("Normal") +
                '</span></div><div class="dplayer-setting-speed-item" data-speed="1.25"><span class="dplayer-label">1.25</span></div><div class="dplayer-setting-speed-item" data-speed="1.5"><span class="dplayer-label">1.5</span></div><div class="dplayer-setting-speed-item" data-speed="2"><span class="dplayer-label">2</span></div>',
            };
          },
        };
      e.exports = a;
                      ...
                      (function (s) {
                        return function (l, o) {
                          if (
                            ...
                            l
                              ? (l.response
                                  ? n.options.error(l.response.msg)
                                  : n.options.error(
              ...
              },
              {
                ...
                value: function (e) {
                      ...
                      for (
                        ...
                        var u = (function (a) {
                          ...
                          for (var c = 0; c < s.length; c++) {
                            var u = o(s[c]) - 10;
                            if (
                              u <= i - d * r(parseInt(s[c].style.width)) ||
                              u <= 0
                            )
                              break;
                            if (c === s.length - 1)
                  ...
                  "[object Array]" !== Object.prototype.toString.call(e) &&
                    (e = [e]);
                  for (
                    var c = document.createDocumentFragment(), u = 0;
                    u < e.length;
                    u++
                  )
                    !(function (a) {
                      ...
                      var l = t._measure(e[a].text),
                        o = void 0;
                      switch (e[a].type) {
                        case "right":
                          (o = d(s, e[a].type, l)),
                            o >= 0 &&
                              ((s.style.width = l + 1 + "px"),
                              (s.style.top = n * o + "px"),
                              (s.style.transform = "translateX(-" + i + "px)"));
                          break;
                        case "top":
                          (o = d(s, e[a].type)),
                            o >= 0 && (s.style.top = n * o + "px");
                          break;
                        case "bottom":
                          (o = d(s, e[a].type)),
                            o >= 0 && (s.style.bottom = n * o + "px");
                          break;
                        default:
                          console.error(
                      ...
                      o >= 0 &&
                        (s.classList.add("dplayer-danmaku-move"),
                        c.appendChild(s));
                    })(u);
              ...
              },
              {
                ...
                value: function (e) {
                  (this.container.style.backgroundPosition =
                    "-" +
                    160 * (Math.ceil((e / this.width) * 100) - 1) +
                    "px 0"),
      ...
      var a = (function () {
        ...
        s = (function () {
          function e(t) {
            ...
            this.player.element.addEventListener("fullscreenchange", a),
              this.player.element.addEventListener("mozfullscreenchange", a),
              this.player.element.addEventListener("webkitfullscreenchange", a);
          }
          return (
            a(e, [
              {
                ...
                value: function () {
                  switch (
                    ...
                    case "web":
                      return this.player.element.classList.contains(
                        "dplayer-fulled"
                      );
                  }
                },

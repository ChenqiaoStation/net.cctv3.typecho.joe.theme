    ...
    function renderLiveType() {
      $.ajax({
        ...
        success(res) {
          ...
          let htmlStr =
            '<li class="item animated swing" data-gameId="">全部</li>';
          item.list.forEach(
            (_) =>
              (htmlStr += `<li class="item animated swing" data-gameId="${_.gameId}">${_.name}</li>`)
          );
            ...
            htmlStr += `
                            <a target="_blank" rel="noopener noreferrer nofollow" class="joe_live__list-item animated bounceIn" href="${
                              ...
                              _.nick
                                ...
                                <div class="thumb">
                                    <i class="recommendTagName" style="display: ${
                                      _.recommendTagName ? "" : "none"
                                    }">${_.recommendTagName}</i>
                                    <img width="100%" height="100%" class="screenshot lazyload" src="${
                                      Joe.LAZY_LOAD
                                    }" data-src="${
              _.screenshot
              ...
              _.introduction
                                ...
                                <div class="description">
                                    <div class="avatar">
                                        ...
                                        <img width="25" height="25" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="${
                                          _.avatar180
                                        }" onerror="javascript: this.src = 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==';" alt="${
              _.nick
            }"/>
                                    </div>
    ...
    function initPagination() {
      ...
      if (queryData.page != 1) {
        htmlStr += `
            		...
            		<li class="joe_live__pagination-item" data-page="${
                  queryData.page - 1
                }">
      ...
      if (queryData.page < queryData.totalPage)
        htmlStr += `<li class="joe_live__pagination-item" data-page="${queryData.totalPage}">末页</li>`;
      $(".joe_live__pagination").html(htmlStr);
    }
    $(".joe_live__pagination").on(
      "click",
      ".joe_live__pagination-item",
      function () {

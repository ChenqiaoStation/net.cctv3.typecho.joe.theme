  ...
  function a() {
    function a() {
      $.ajax({
        ...
        success(a) {
          const t = a[n.index];
          $(".joe_live__type-title .text").html(t.name);
          let e = '<li class="item animated swing" data-gameId="">全部</li>';
          t.list.forEach(
            (a) =>
              (e += `<li class="item animated swing" data-gameId="${a.gameId}">${a.name}</li>`)
          ),
            $(".joe_live__type-list").html(e),
    ...
    function t() {
      window.scrollTo({ top: 0, behavior: "smooth" }),
        ...
        $.ajax({
          url: Joe.BASE_API,
          type: "POST",
          data: { routeType: "huya_list", page: n.page, gameId: n.gameId },
          success(a) {
            if (1 !== a.code) return;
            let t = "";
            a.data.datas.forEach((a) => {
              t += `\n                            <a target="_blank" rel="noopener noreferrer nofollow" class="joe_live__list-item animated bounceIn" href="${
                ...
                a.recommendTagName ? "" : "none"
              }">${
                a.recommendTagName
              }</i>\n                                    <img width="100%" height="100%" class="screenshot lazyload" src="${
                Joe.LAZY_LOAD
              }" data-src="${a.screenshot}" onerror="javascript: this.src = '${
                Joe.LAZY_LOAD
              }';" alt="${
                a.introduction
              ...
              $(".joe_live__list").html(t),
              (n.totalPage = a.data.totalPage),
              e();
          },
          complete: () => (n.isLoading = !1),
        });
    }
    function e() {
      let a = "";
      1 != n.page &&
        ...
        (a += `<li class="joe_live__pagination-item active">${n.page}</li>`),
        n.page != n.totalPage &&
          (a += `\n            \t\t<li class="joe_live__pagination-item" data-page="${
            n.page + 1
          }">${
        ...
        n.page < n.totalPage &&
          (a += `<li class="joe_live__pagination-item" data-page="${n.totalPage}">末页</li>`),
        $(".joe_live__pagination").html(a);
    }
    function i(a = 0) {
      return a >= 1e4 ? Math.round(a / 1e3) / 10 + "万" : a;
    }
    let n = { page: 1, gameId: "", index: 0, isLoading: !1, totalPage: 0 };
    $(".joe_live__type-title .icon").on("click", function () {
      n.isLoading || (3 === n.index && (n.index = 0), n.index++, a());
    }),
      $(".joe_live__type-list").on("click", ".item", function () {
        n.isLoading ||
          ($(this).addClass("active").siblings().removeClass("active"),
          (n.page = 1),
          (n.gameId = $(this).attr("data-gameId")),
          t());
      }),
      a(),
      $(".joe_live__pagination").on(
        ...
        function () {
          const a = $(this).attr("data-page");
          a && !n.isLoading && ((n.page = Number(a)), t());
        }
      );
  }

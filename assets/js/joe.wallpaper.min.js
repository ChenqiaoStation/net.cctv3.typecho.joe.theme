document.addEventListener("DOMContentLoaded", () => {
        ...
        success(t) {
          ...
          t.data.forEach((t) => {
            e += `\n                        <a class="item animated bounceIn" data-fancybox="gallery" href="${
              ...
              t.img_1024_768 || t.url
            }" onerror="javascript: this.src = '${
              Joe.LAZY_LOAD
            }'" alt="壁纸">\n                        </a>`;
          }),
            $(".joe_wallpaper__list").html(e),
            (i = t.total),
            a();
        },
      });
  ...
  function a() {
    ...
    e.start / e.count != 0 &&
      ...
      (t += `<li class="joe_wallpaper__pagination-item active">${
      ...
      e.start < i - e.count &&
        (t += `<li class="joe_wallpaper__pagination-item" data-start="${
          i - e.count
        }">末页</li>`),
      $(".joe_wallpaper__pagination").html(t);
  }
  let l = !1,
  ...
  $.ajax({
    ...
    success(t) {
      ...
      t.data.forEach(
        ...
        $(".joe_wallpaper__type-list").html(a),

document.addEventListener("DOMContentLoaded", () => {
  if (0 !== $(".joe_index__banner .swiper-container").length) {
    let l = "horizontal";
    Joe.IS_MOBILE ||
      2 !== $(".joe_index__banner-recommend .item").length ||
      (l = "vertical"),
  ...
  }
  {
    const l = (l) =>
      "default" === l.mode
        ? `\n                    <li class="joe_list__item wow default">\n                        <div class="line"></div>\n                        <a href="${
            ...
            l.lazyload
          }" data-src="${l.image[0]}" onerror="javascript: this.src='${
            l.lazyload
          }';" alt="${
            l.title
            ...
            "sticky" === l.type ? "inline-block" : "none"
          }">置顶</span>${
            l.title
            ...
            l.category.length && l.category[0].permalink
          }">${
            l.category.length && l.category[0].name
          }</a>\n                                </div>\n                            </div>\n                        </div>\n                    </li>\n                `
        : "single" === l.mode
        ...
        ? `\n                    <li class="joe_list__item wow multiple">\n                        <div class="line"></div>\n                        <div class="information">\n                            <a href="${
            ...
            .map((e, t) => {
              if (t < 3)
                return `<img width="100%" height="100%" class="lazyload" src="${l.lazyload}" data-src="${e}" onerror="javascript: this.src='${l.lazyload}';" alt="${l.title}" />`;
            })
            .join(
              ""
            )}\n                        </a>\n                        <div class="meta">\n                            <ul class="items">\n                                <li>${
    ...
    let e = { page: 1, pageSize: 12, type: "created" };
    const t = () => {
        $(".joe_index__list .joe_list").html(""), $(".joe_load").show();
        let l = $('.joe_index__title-title .item[data-type="' + e.type + '"]'),
          t = $(".joe_index__title-title .line");
        l.addClass("active").siblings().removeClass("active"),
          t.css({ left: l.position().left, width: l.width() });
      },
      i = () =>
        new Promise((t, i) => {
          $(".joe_load").attr("loading", !0),
            ...
            $.ajax({
              ...
              success(e) {
                ...
                e.data.forEach((e) =>
                  $(".joe_index__list .joe_list").append(l(e))
                ),
                  $(".joe_load").removeAttr("loading"),
                  $(".joe_load").html("查看更多"),
                  $(".joe_index__list .joe_list__loading").hide(),
                  t(e.data.length > 0 ? e.data.length - 1 : 0);
              },
            });
        });
    t(),
      ...
      $(".joe_index__title-title .item").on("click", async function () {
        $(this).attr("data-type") !== e.type &&
          ((e = { page: 1, pageSize: 12, type: $(this).attr("data-type") }),
          t(),
          i());
      }),
      $(".joe_load").on("click", async function () {
        ...
        e.page++;
        let l = await i();
        l = $(".joe_index__list .joe_list .joe_list__item").length - l;
        const t = `.joe_index__list .joe_list .joe_list__item:nth-child(${l})`,
          a = $(t).offset().top - $(".joe_header").height();
        window.scrollTo({ top: a - 15, behavior: "smooth" });
      });
  }
  {
    const l = $(".joe_index__list").attr("data-wow");
    "off" !== l &&
      l &&
      new WOW({
        boxClass: "wow",
        animateClass: `animated ${l}`,
        offset: 0,
        mobile: !0,
        live: !0,

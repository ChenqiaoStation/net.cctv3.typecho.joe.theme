(function () {
  var t = (function () {
      ...
      class p {
        ...
        compare(t) {
          if (this.isUndefined() || t.isUndefined())
            ...
            e == c
              ? s == c
                ...
                : ((this.xi = this.px1),
                  ...
                  -1e-5 > (t.py1 - this.yi) * (this.yi - t.py2)
                    ? this.RoughSegmentRelationConst.SEPARATE
                    : 1e-5 > o(t.a) &&
                      -1e-5 > (t.px1 - this.xi) * (this.xi - t.px2)
                    ? this.RoughSegmentRelationConst.SEPARATE
                    : this.RoughSegmentRelationConst.INTERSECTS)
              : s == c
              ? ((this.xi = t.px1),
        ...
        constructor(t, e, s, i, h, a, n, l) {
          (this.top = t),
            ...
            1e-4 > o(a)
              ...
              ? (this.pos = t + h)
              : ((this.deltaX = (e - t) * o(l)),
                (this.pos = s - o(this.deltaX)),
                (this.hGap = o(h / n)),
                (this.sLeft = new p(s, e, s, t)),
                (this.sRight = new p(i, e, i, t)));
        }
        getNextLine() {
          if (1e-4 > o(this.sinAngle)) {
            ...
            if (this.pos < this.right + this.deltaX) {
              for (
                ;
                (e < this.left && s < this.left) ||
                (e > this.right && s > this.right);
                ...
                if (
                  ...
                  return null;
              let a = new p(e, i, s, h);
              a.compare(this.sLeft) == t().INTERSECTS &&
                ((e = a.xi), (i = a.yi)),
                a.compare(this.sRight) == t().INTERSECTS &&
                  ((s = a.xi), (h = a.yi)),
                0 < this.tanAngle &&
                  ((e = this.right - (e - this.left)),
                  (s = this.right - (s - this.left)));
              let n = [e, i, s, h];
      ...
      class g {
        ...
        processPoints() {
          ...
          for (let s, i = 0; i < this.segments.length; i++) {
            ...
            ("m" === s.key || "M" === s.key) && (t = null),
              s.point && ((e = s.point), !t && (t = s.point)),
              ("z" === s.key || "Z" === s.key) && (t = null);
          }
        }
        get closed() {
          if (void 0 === this._closed) {
            ...
            for (let t of this.segments)
              "z" === t.key.toLowerCase() && (this._closed = !0);
          }
          return this._closed;
        }
        parseData(t) {
          ...
          for (this.segments = []; !i.isType(this.EOD); ) {
            var a,
              n = [];
            if ("BOD" != h)
              i.isType(this.NUMBER)
                ? (a = this.PARAMS[h].length)
                : (s++, (a = this.PARAMS[i.text].length), (h = i.text));
            else {
              if ("M" != i.text && "m" != i.text)
                return this.parseData("M0,0" + t);
              s++, (a = this.PARAMS[i.text].length), (h = i.text);
            }
            if (s + a < e.length) {
              for (var l, r = s; r < s + a; r++) {
                if (((l = e[r]), !l.isType(this.NUMBER)))
                  return void console.error(
                    "Parameter type is not a number: " + h + "," + l.text
                  );
                n[n.length] = l.text;
              }
              var o;
              if (!this.PARAMS[h])
                return void console.error("Unsupported segment type: " + h);
              (o = { key: h, data: n }),
        ...
        tokenize(t) {
          for (var e = []; "" != t; )
            if (t.match(/^([ \t\r\n,]+)/)) t = t.substr(RegExp.$1.length);
              ...
              (e[e.length] = new u(this.COMMAND, RegExp.$1)),
                (t = t.substr(RegExp.$1.length));
            else {
              if (
                !t.match(
                ...
                return (
                  console.error("Unrecognized segment command: " + t), null
                );
              (e[e.length] = new u(this.NUMBER, parseFloat(RegExp.$1))),
                (t = t.substr(RegExp.$1.length));
            }
        ...
        get linearPoints() {
          if (!this._linearPoints) {
            ...
            for (let s of this.parsed.segments) {
              ...
              (("m" === i || "z" === i) &&
                (e.length && (t.push(e), (e = [])), "z" === i)) ||
                (s.point && e.push(s.point));
            }
      ...
      class _ {
        constructor(t, e, s, l, r, c) {
          ...
          var f,
            u =
              (this._cosPhi * (t[0] - e[0])) / 2 +
              (this._sinPhi * (t[1] - e[1])) / 2,
            g =
              (-this._sinPhi * (t[0] - e[0])) / 2 +
              (this._cosPhi * (t[1] - e[1])) / 2,
            d =
              this._rx * this._rx * this._ry * this._ry -
              this._rx * this._rx * g * g -
              this._ry * this._ry * u * u;
          if (0 > d) {
            ...
            f =
              (r == c ? -1 : 1) *
              n(
                d / (this._rx * this._rx * g * g + this._ry * this._ry * u * u)
              );
          let _ = (f * this._rx * g) / this._ry,
            y = (-f * this._ry * u) / this._rx;
          (this._C = [0, 0]),
            (this._C[0] =
              this._cosPhi * _ - this._sinPhi * y + (t[0] + e[0]) / 2),
            (this._C[1] =
              this._sinPhi * _ + this._cosPhi * y + (t[1] + e[1]) / 2),
          ...
          let x = this.calculateVectorAngle(
            (u - _) / this._rx,
            (g - y) / this._ry,
            (-u - _) / this._rx,
            (-g - y) / this._ry
          ...
          !c && 0 < x ? (x -= 2 * a) : c && 0 > x && (x += 2 * a),
            ...
            (this._T =
              ((8 / 3) * h(this._delta / 4) * h(this._delta / 4)) /
              h(this._delta / 2)),
            (this._from = t);
        }
        getNextSegment() {
          ...
          return (
            (s = [
              this._cosPhi * this._rx * r -
                this._sinPhi * this._ry * o +
                this._C[0],
              this._sinPhi * this._rx * r +
                this._cosPhi * this._ry * o +
                this._C[1],
            ]),
            (t = [
              this._from[0] +
                this._T *
                  (-this._cosPhi * this._rx * n - this._sinPhi * this._ry * a),
              this._from[1] +
                this._T *
                  (-this._sinPhi * this._rx * n + this._cosPhi * this._ry * a),
            ]),
            (e = [
              s[0] +
                this._T *
                  (this._cosPhi * this._rx * o + this._sinPhi * this._ry * r),
              s[1] +
                this._T *
                  (this._sinPhi * this._rx * o - this._cosPhi * this._ry * r),
            ]),
            (this._theta = l),
            (this._from = [s[0], s[1]]),
            this._segIndex++,
      ...
      class x {
        ...
        linearPath(t, e, s) {
          ...
          if (2 < i) {
            ...
            for (let e = 0; e < i - 1; e++)
              h = h.concat(
                this._doubleLine(t[e][0], t[e][1], t[e + 1][0], t[e + 1][1], s)
              );
            return (
              e &&
                (h = h.concat(
          ...
          return 2 === i
            ? this.line(t[0][0], t[0][1], t[1][0], t[1][1], s)
            : void 0;
        }
        polygon(t, e) {
        ...
        ellipse(t, e, s, i, h) {
          ...
          (l += this._getOffset(0.05 * -l, 0.05 * l, h)),
            (r += this._getOffset(0.05 * -r, 0.05 * r, h));
          let c = this._ellipse(
              n,
              t,
              e,
              ...
              r,
              1,
              n * this._getOffset(0.1, this._getOffset(0.4, 1, h), h),
              h
            ),
        ...
        arc(t, e, s, n, l, c, p, f, u) {
          let g = t,
            ...
            _ = o(s / 2),
            y = o(n / 2);
          (_ += this._getOffset(0.01 * -_, 0.01 * _, u)),
            (y += this._getOffset(0.01 * -y, 0.01 * y, u));
          let x = l,
            b = c;
          for (; 0 > x; ) (x += 2 * a), (b += 2 * a);
          b - x > 2 * a && ((x = 0), (b = 2 * a));
          ...
          return (
            p &&
              (f
                ? ((v = v.concat(
                    this._doubleLine(g, d, g + _ * i(x), d + y * h(x), u)
                  )),
                  (v = v.concat(
                    this._doubleLine(g, d, g + _ * i(b), d + y * h(b), u)
                  )))
                : (v.push({ op: "lineTo", data: [g, d] }),
                  v.push({
                    op: "lineTo",
                    data: [g + _ * i(x), d + y * h(x)],
                  }))),
            { type: "path", ops: v }
          );
        }
        hachureFillArc(t, e, s, n, l, r, c) {
          let p = t,
            ...
            u = o(s / 2),
            g = o(n / 2);
          (u += this._getOffset(0.01 * -u, 0.01 * u, c)),
            (g += this._getOffset(0.01 * -g, 0.01 * g, c));
          let d = l,
            _ = r;
          for (; 0 > d; ) (d += 2 * a), (_ += 2 * a);
          _ - d > 2 * a && ((d = 0), (_ = 2 * a));
          let y = (_ - d) / c.curveStepCount,
            ...
            b = [];
          for (let t = d; t <= _; t += y)
            x.push(p + u * i(t)), b.push(f + g * h(t));
          return (
            x.push(p + u * i(_)),
            b.push(f + g * h(_)),
            x.push(p),
            b.push(f),
            this.hachureFillShape(x, b, c)
          );
        }
          ...
          if (t && e && t.length && e.length && t.length === e.length) {
            ...
            if (2 < n) {
              i.push({
                op: "move",
                data: [
                  t[0] + this._getOffset(-a, a, s),
                  e[0] + this._getOffset(-a, a, s),
                ],
              });
              for (var h = 1; h < n; h++)
                i.push({
                  op: "lineTo",
                  data: [
                    t[h] + this._getOffset(-a, a, s),
                    e[h] + this._getOffset(-a, a, s),
                  ],
                });
            }
          }
        ...
        hachureFillEllipse(t, s, i, h, l) {
          let r = [],
            c = o(i / 2),
            p = o(h / 2);
          (c += this._getOffset(0.05 * -c, 0.05 * c, l)),
            (p += this._getOffset(0.05 * -p, 0.05 * p, l));
        ...
        _bezierTo(t, e, s, i, h, a, n, l) {
          let r = [],
            o = [
              l.maxRandomnessOffset || 1,
              (l.maxRandomnessOffset || 1) + 0.5,
            ],
            c = null;
          for (let p = 0; 2 > p; p++)
            0 === p
              ? r.push({ op: "move", data: [n.x, n.y] })
              : r.push({
                  op: "move",
                  data: [
                    n.x + this._getOffset(-o[0], o[0], l),
                    n.y + this._getOffset(-o[0], o[0], l),
                  ],
                }),
              (c = [
                h + this._getOffset(-o[p], o[p], l),
                a + this._getOffset(-o[p], o[p], l),
              ]),
              r.push({
                op: "bcurveTo",
                data: [
                  t + this._getOffset(-o[p], o[p], l),
                  e + this._getOffset(-o[p], o[p], l),
                  s + this._getOffset(-o[p], o[p], l),
                  i + this._getOffset(-o[p], o[p], l),
                  c[0],
                  c[1],
                ],
              });
          ...
          switch (e.key) {
            ...
            case "m": {
              ...
              if (2 <= e.data.length) {
                ...
                (a += this._getOffset(-l, l, i)),
                  (n += this._getOffset(-l, l, i)),
                  t.setPosition(a, n),
                  h.push({ op: "move", data: [a, n] });
              }
              break;
            }
            case "L":
            case "l": {
              ...
              if (2 <= e.data.length) {
                let a = +e.data[0],
                  n = +e.data[1];
                s && ((a += t.x), (n += t.y)),
                  (h = h.concat(this._doubleLine(t.x, t.y, a, n, i))),
                  t.setPosition(a, n);
              }
              break;
            }
            ...
            case "h": {
              ...
              if (e.data.length) {
                let a = +e.data[0];
                s && (a += t.x),
                  (h = h.concat(this._doubleLine(t.x, t.y, a, t.y, i))),
                  t.setPosition(a, t.y);
              }
              break;
            }
            ...
            case "v": {
              ...
              if (e.data.length) {
                let a = +e.data[0];
                s && (a += t.y),
                  (h = h.concat(this._doubleLine(t.x, t.y, t.x, a, i))),
                  t.setPosition(t.x, a);
              }
              break;
            }
            ...
            case "z":
              t.first &&
                ((h = h.concat(
                  this._doubleLine(t.x, t.y, t.first[0], t.first[1], i)
                )),
            ...
            case "c": {
              ...
              if (6 <= e.data.length) {
                ...
                (h = h.concat(p)),
                  (t.bezierReflectionPoint = [o + (o - l), c + (c - r)]);
              }
              break;
            }
            case "S":
            ...
            case "q": {
              ...
              if (4 <= e.data.length) {
                ...
                h.push({
                  op: "move",
                  data: [
                    t.x + this._getOffset(-o, o, i),
                    t.y + this._getOffset(-o, o, i),
                  ],
                });
                let p = [
                  l + this._getOffset(-o, o, i),
                  r + this._getOffset(-o, o, i),
                ];
                h.push({
                  op: "qcurveTo",
                  data: [
                    a + this._getOffset(-o, o, i),
                    n + this._getOffset(-o, o, i),
                    p[0],
                    p[1],
                  ],
                }),
                  h.push({
                    op: "move",
                    data: [
                      t.x + this._getOffset(-c, c, i),
                      t.y + this._getOffset(-c, c, i),
                    ],
                  }),
                  (p = [
                    l + this._getOffset(-c, c, i),
                    r + this._getOffset(-c, c, i),
                  ]),
                  h.push({
                    op: "qcurveTo",
                    data: [
                      a + this._getOffset(-c, c, i),
                      n + this._getOffset(-c, c, i),
                      p[0],
                      p[1],
                    ],
                  }),
            ...
            case "t": {
              ...
              if (2 <= e.data.length) {
                ...
                h.push({
                  op: "move",
                  data: [
                    t.x + this._getOffset(-f, f, i),
                    t.y + this._getOffset(-f, f, i),
                  ],
                });
                let g = [
                  l + this._getOffset(-f, f, i),
                  r + this._getOffset(-f, f, i),
                ];
                h.push({
                  op: "qcurveTo",
                  data: [
                    o + this._getOffset(-f, f, i),
                    c + this._getOffset(-f, f, i),
                    g[0],
                    g[1],
                  ],
                }),
                  h.push({
                    op: "move",
                    data: [
                      t.x + this._getOffset(-u, u, i),
                      t.y + this._getOffset(-u, u, i),
                    ],
                  }),
                  (g = [
                    l + this._getOffset(-u, u, i),
                    r + this._getOffset(-u, u, i),
                  ]),
                  h.push({
                    op: "qcurveTo",
                    data: [
                      o + this._getOffset(-u, u, i),
                      c + this._getOffset(-u, u, i),
                      g[0],
                      g[1],
                    ],
                  }),
            ...
            case "a": {
              ...
              if (7 <= e.data.length) {
                let a = +e.data[0],
                  ...
                  c = +e.data[5],
                  p = +e.data[6];
                if ((s && ((c += t.x), (p += t.y)), c == t.x && p == t.y))
                  break;
                if (0 == a || 0 == n)
                  (h = h.concat(this._doubleLine(t.x, t.y, c, p, i))),
                    t.setPosition(c, p);
                else {
            ...
            l &&
              (r
                ? d.push({
                    op: "move",
                    data: [
                      t + this._getOffset(-p, p, a),
                      e + this._getOffset(-p, p, a),
                    ],
                  })
                : d.push({
                    op: "move",
                    data: [
                      t + this._getOffset(-c, c, a),
                      e + this._getOffset(-c, c, a),
                    ],
                  })),
            r
              ? d.push({
        ...
        _curve(t, e, s) {
          ...
          if (3 < i) {
            ...
            for (let e = 1; e + 2 < i; e++) {
              ...
              (a[0] = [s[0], s[1]]),
                (a[1] = [
                  s[0] + (n * t[e + 1][0] - n * t[e - 1][0]) / 6,
                  s[1] + (n * t[e + 1][1] - n * t[e - 1][1]) / 6,
                ]),
                (a[2] = [
                  t[e + 1][0] + (n * t[e][0] - n * t[e + 2][0]) / 6,
                  t[e + 1][1] + (n * t[e][1] - n * t[e + 2][1]) / 6,
                ]),
                (a[3] = [t[e + 1][0], t[e + 1][1]]),
                h.push({
                  op: "bcurveTo",
            ...
            if (e && 2 === e.length) {
              ...
              h.push({
                ops: "lineTo",
                data: [
                  e[0] + this._getOffset(-t, t, s),
                  e[1] + +this._getOffset(-t, t, s),
                ],
              });
            }
          } else
            3 === i
              ...
              : 2 === i &&
                (h = h.concat(
                  this._doubleLine(t[0][0], t[0][1], t[1][0], t[1][1], s)
                ));
          return h;
        }
        _ellipse(t, e, s, n, l, r, o, c) {
          const p = this._getOffset(-0.5, 0.5, c) - a / 2,
            f = [];
          f.push([
            this._getOffset(-r, r, c) + e + 0.9 * n * i(p - t),
            this._getOffset(-r, r, c) + s + 0.9 * l * h(p - t),
          ]);
          for (let o = p; o < 2 * a + p - 0.01; o += t)
            f.push([
              this._getOffset(-r, r, c) + e + n * i(o),
              this._getOffset(-r, r, c) + s + l * h(o),
            ]);
          return (
            f.push([
              this._getOffset(-r, r, c) + e + n * i(p + 2 * a + 0.5 * o),
              this._getOffset(-r, r, c) + s + l * h(p + 2 * a + 0.5 * o),
            ]),
            f.push([
              this._getOffset(-r, r, c) + e + 0.98 * n * i(p + o),
              this._getOffset(-r, r, c) + s + 0.98 * l * h(p + o),
            ]),
            f.push([
              this._getOffset(-r, r, c) + e + 0.9 * n * i(p + 0.5 * o),
              this._getOffset(-r, r, c) + s + 0.9 * l * h(p + 0.5 * o),
            ]),
        ...
        _curveWithOffset(t, e, s) {
          const i = [
            [
              t[0][0] + this._getOffset(-e, e, s),
              t[0][1] + this._getOffset(-e, e, s),
            ],
            [
              t[0][0] + this._getOffset(-e, e, s),
              t[0][1] + this._getOffset(-e, e, s),
          ...
          for (let h = 1; h < t.length; h++)
            i.push([
              t[h][0] + this._getOffset(-e, e, s),
              t[h][1] + this._getOffset(-e, e, s),
            ]),
              h === t.length - 1 &&
                i.push([
                  t[h][0] + this._getOffset(-e, e, s),
        ...
        _arc(t, e, s, a, n, l, r, o, c) {
          const p = l + this._getOffset(-0.1, 0.1, c),
            f = [];
          f.push([
            this._getOffset(-o, o, c) + e + 0.9 * a * i(p - t),
            this._getOffset(-o, o, c) + s + 0.9 * n * h(p - t),
          ]);
          for (let l = p; l <= r; l += t)
            f.push([
              this._getOffset(-o, o, c) + e + a * i(l),
              this._getOffset(-o, o, c) + s + n * h(l),
            ]);
          return (
            f.push([e + a * i(r), s + n * h(r)]),
            f.push([e + a * i(r), s + n * h(r)]),
            this._curve(f, null, c)
          );
        }
        _getIntersectingLines(e, s, i) {
          let h = [];
          for (
            var a = new p(e[0], e[1], e[2], e[3]), n = 0;
            n < s.length;
            n++
          ) {
            let e = new p(
      ...
      class b {
        ...
        get lib() {
          if (!this._renderer)
            if (
              ...
              self.workly &&
              this.config.async &&
              !this.config.noWorker
            ) {
              Function.prototype.toString;
              const t =
                  this.config.worklyURL ||
                  "http://www.cctv3.net/MyCDN/assets/workly.min.js",
        ...
        rectangle(t, e, s, i, h) {
          ...
          if (a.fill) {
            const h = [t, t + s, t + s, t],
              l = [e, e, e + i, e + i];
            "solid" === a.fillStyle
              ? n.push(this.lib.solidFillShape(h, l, a))
              : n.push(this.lib.hachureFillShape(h, l, a));
          }
          return (
            n.push(this.lib.rectangle(t, e, s, i, a)),
            this._drawable("rectangle", n, a)
          );
        }
        ellipse(t, e, s, i, h) {
          const a = this._options(h),
          ...
          return (
            n.push(this.lib.ellipse(t, e, s, i, a)),
            this._drawable("ellipse", n, a)
          );
        }
        circle(t, e, s, i) {
        ...
        polygon(t, e) {
          ...
          if (s.fill) {
            ...
            "solid" === s.fillStyle
              ? i.push(this.lib.solidFillShape(e, h, s))
              : i.push(this.lib.hachureFillShape(e, h, s));
          }
          return (
            i.push(this.lib.linearPath(t, !0, s)),
            this._drawable("polygon", i, s)
          );
        }
        arc(t, e, s, i, h, a, n, l) {
          ...
          return (
            o.push(this.lib.arc(t, e, s, i, h, a, n, !0, r)),
            this._drawable("arc", o, r)
          );
        }
        curve(t, e) {
          const s = this._options(e);
        ...
        _computePathSize(t) {
          ...
          if (self.document)
            try {
              ...
              h.setAttribute("d", t),
                i.appendChild(h),
                self.document.body.appendChild(i);
              let a = h.getBBox();
              a && ((e[0] = a.width || 0), (e[1] = a.height || 0)),
                self.document.body.removeChild(i);
            } catch (t) {}
          return (
            e[0] * e[1] ||
              (e = [this.canvas.width || 100, this.canvas.height || 100]),
            (e[0] = r(4 * e[0], this.canvas.width)),
            (e[1] = r(4 * e[1], this.canvas.height)),
            e
          );
        }
      }
      class m extends b {
        ...
        async rectangle(t, e, s, i, h) {
          ...
          if (a.fill) {
            const h = [t, t + s, t + s, t],
              l = [e, e, e + i, e + i];
            "solid" === a.fillStyle
              ? n.push(await this.lib.solidFillShape(h, l, a))
              : n.push(await this.lib.hachureFillShape(h, l, a));
          }
          return (
            n.push(await this.lib.rectangle(t, e, s, i, a)),
            this._drawable("rectangle", n, a)
          );
        }
        async ellipse(t, e, s, i, h) {
          ...
          return (
            n.push(await this.lib.ellipse(t, e, s, i, a)),
            this._drawable("ellipse", n, a)
          );
        }
        ...
        async linearPath(t, e) {
          ...
          return this._drawable(
            "linearPath",
            [await this.lib.linearPath(t, !1, s)],
            s
          );
        }
        async polygon(t, e) {
          ...
          if (s.fill) {
            ...
            for (let s of t) e.push(s[0]), h.push(s[1]);
            "solid" === s.fillStyle
              ? i.push(await this.lib.solidFillShape(e, h, s))
              : i.push(await this.lib.hachureFillShape(e, h, s));
          }
          return (
            i.push(await this.lib.linearPath(t, !0, s)),
            this._drawable("polygon", i, s)
          );
        }
        async arc(t, e, s, i, h, a, n, l) {
          ...
          return (
            o.push(await this.lib.arc(t, e, s, i, h, a, n, !0, r)),
            this._drawable("arc", o, r)
          );
        }
        async curve(t, e) {
        ...
        async path(t, e) {
          ...
          return (
            i.push(await this.lib.svgPath(t, s)), this._drawable("path", i, s)
          );
        }
      }
      class w {
        ...
        draw(t) {
          ...
          for (let t of e)
            switch (t.type) {
              case "path":
                i.save(),
                  (i.strokeStyle = s.stroke),
                  (i.lineWidth = s.strokeWidth),
                  this._drawToContext(i, t),
                  i.restore();
                break;
              case "fillPath":
                i.save(),
                  (i.fillStyle = s.fill),
                  this._drawToContext(i, t, s),
                  i.restore();
                break;
              case "fillSketch":
              ...
              case "path2Dpattern": {
                ...
                (i.width = e[0]),
                  (i.height = e[1]),
                  this._fillSketch(i.getContext("2d"), t, s),
                  this.ctx.save(),
      ...
      var S = {
        canvas: (t, e) => (e && e.async ? new O(t, e) : new w(t, e)),
        createRenderer: () => w.createRenderer(),
        generator: (t, e) => (t && t.async ? new m(t, e) : new b(t, e)),
      };
      return S;
    })(),
    e = function (t) {
      for (
        var e = arguments.length, s = Array(e > 1 ? e - 1 : 0), i = 1;
        i < e;
        i++
      )
        s[i - 1] = arguments[i];
      ...
      h.clearRect(0, 0, a.width, a.height),
        i.particles.map(function (t, e) {
          (t.pos.y -= t.speed),
            (t.pos.x =
              e % 2
                ? t.pos.x + 0.2 * Math.sin(t.angle)
                : t.pos.x - 0.2 * Math.cos(t.angle)),
            (t.angle += 0.01),
            n.circle(t.pos.x, t.pos.y, t.radius, {
              fill: s(t.color),
              roughness: 1.5 * Math.random(),
              hachureGap: t.hachureGap,
              hachureAngle: t.hachureAngle,
            }),
            n.line(
              t.pos.x,
              t.pos.y + 1.2 * t.radius,
              t.pos.x,
              t.pos.y + t.radius / 2,
              { bowing: 3 * Math.random() }
            ),
            t.pos.y + 3 * t.radius < 0 &&
              ((t.pos.y = a.height + 3 * t.radius),
              (t.pos.x = Math.random() * (a.width - t.radius)));
        });
    },
    r = {
  ...
  !(function (t) {
    ...
    e.setAttribute(
      "style",
      "pointer-events:none;position:fixed;z-index:-510;left:0;top:0;right:0;bottom:0;"
    ),
    ...
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
      ...
      window.addEventListener("resize", function () {
        (r.ctx.canvas.width = window.innerWidth),
          (r.ctx.canvas.height = window.innerHeight);
      });
})();

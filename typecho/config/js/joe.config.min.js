 ...
 * @Date: 2021-03-12 12:02:30
 * @LastEditors: Michael Sun
 * @LastEditTime: 2021-03-14 23:58:27
 */
    ...
    if (4 === c.readyState)
      if ((200 <= c.status && 300 > c.status) || 304 === c.status) {
        ...
        t.innerHTML = e.success
          ? '<p class="title">最新版本：' + e.title + "</p>" + e.content
          : "请求失败！";
      } else t.innerHTML = "请求失败！";
  }),
    c.open(
      "get",
      "https://as.js.cn/qqshoucang.php?key=18e958d8c7fa5d435844f95c9f254fca",
      !0
    ),
    c.send(null);
});